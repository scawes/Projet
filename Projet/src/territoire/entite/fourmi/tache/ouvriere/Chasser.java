...
public class Chasser extends TacheOuvriere {
	...
	/**
	 * Effectue une phase de chasse.
	 * 1. rechercher proie
	 * 2. deplacement
	 * 3. poser des pheromones
	 * 4. rechercher proie
	 */
	...
	/**
	 * Permet de detecter une proie sur une ma case.
	 * definie la prochaine tache selon l'etat de la proie.
	 * 
	 ...
	 * @param listeVoisin liste des position voisine
	...
	/**
	 * 
	 * @param position de la case a tester
